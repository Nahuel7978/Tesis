...
class RobotController(CSVRobot): 
    ...
    def __init__(self):
        ...
        self.robotTimestep = int(self.getBasicTimeStep())
        self.TIMESTEP = self.robotTimestep
...
#-----Deepbots-----
    ...
    def done(self):
        return self.estimuloEncontrado(0.3)
