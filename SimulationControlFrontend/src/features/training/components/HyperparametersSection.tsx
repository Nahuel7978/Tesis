...
const ALGORITHM_PARAMS: Record<TrainingAlgorithm, Array<{
  ...
  [TrainingAlgorithm.DQN]: [
    ...
    { key: 'learning_starts', label: 'Learning starts', type: 'number', min: 100, max: 1000, step: 100, description: 'Cuántos pasos se deben hacer para empezar a entrenar' },
    { key: 'gamma', label: 'Gamma', type: 'number', min: 0.8, max: 1.0, step: 0.001, description: 'Factor de descuento (0.99 es común)' },
    { key: 'train_freq', label: 'Frecuencia de entrenamiento', type: 'number', min: 1, max: 10, step: 1, description: 'Actualiza el modelo cada train_freq de pasos' },
